...
public class AnimalRepositoryCustomImpl implements AnimalRepositoryCustom {
	...
	public List<AnimalResponse> getAnimals(
		...
		if (request.cursorId() != null) {
			cursorCondition = (sortDirection == SortDirection.LATEST)
				? animal.id.lt(request.cursorId())
				: animal.id.gt(request.cursorId());
		}
	...
	@Override
	public Long getAnimalsCount(String startDate, String endDate, Species species, String breedType,
		NeuteredState neuteredState, Sex sex, String city, String town) {
